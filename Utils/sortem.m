function [P2,D2]=sortem(P,D)
    ...
    %D2=diag(sort(diag(D))); % make diagonal matrix out of sorted diagonal values of input D
    %[c, ind]=sort(diag(D)); % store the indices of which columns the sorted eigenvalues come from
